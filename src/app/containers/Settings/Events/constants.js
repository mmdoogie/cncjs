...
export const mapEventToName = (evt) => {
    const eventNameMap = {
        ...
        'gcode:M0': i18n._('G-code: M0 Hold Encountered'),
        'gcode:M1': i18n._('G-code: M1 Hold Encountered'),
        'gcode:M5': i18n._('G-code: M5 Spindle Stop Encountered'),
        'gcode:M6': i18n._('G-code: M6 Tool Change Encountered'),
